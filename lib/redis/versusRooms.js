...
export async function joinRoom(roomId, sessionId, playerName) {
  try {
    ...
    if (!room.players.player2) {
      ...
      console.log(`[versusRooms] Player ${sessionId} joined room ${roomId} as player2`);
    }
...
export async function updateRoomState(roomId, state, expectedVersion = null) {
  try {
    ...
    console.log(`[versusRooms] updateRoomState - Updating room, roomId: ${roomId}, expectedVersion: ${expectedVersion}, currentVersion: ${currentVersion}, newVersion: ${newVersion}, time: ${updateStartTime}`);
    // #endregion
    ...
    console.log(`[versusRooms] updateRoomState - Room updated, roomId: ${roomId}, duration: ${updateEndTime - updateStartTime}ms, time: ${updateEndTime}`);
    // #endregion
