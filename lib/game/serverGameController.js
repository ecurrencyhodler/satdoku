...
// handlePurchaseLife is only called from webhook handler, not from client actions
...
export class ServerGameController {
  ...
  static async processAction(sessionId, action, expectedVersion = null) {
    ...
    switch (action.action) {
      ...
      // purchaseLife is handled by webhook handler only, not accessible via client API
      default:
        return {
          success: false,
