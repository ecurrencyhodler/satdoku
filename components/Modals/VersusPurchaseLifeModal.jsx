...
const VERSUS_LIFE_PURCHASE_PRICE_SATS = 500;

export default function VersusPurchaseLifeModal({ isOpen, onClose, onSuccess, roomId }) {
  ...
  const handlePurchase = async () => {
    ...
    navigate({
      title: 'Versus Life',
      description: 'Buy a life to keep playing in versus mode',
      amount: VERSUS_LIFE_PURCHASE_PRICE_SATS,
      currency: 'SAT', // Amount is in satoshis
      metadata: {
        type: 'versus_life_purchase',
        successUrl: `/purchase-success?checkout-id={CHECKOUT_ID}&type=versus_life_purchase&roomId=${roomId || ''}`,
      },
    });
      ...
      <div className="modal-content">
        ...
        <div className="modal-actions">
          <button
            ...
            disabled={isDisabled}
          >
            {isDisabled ? 'Creating checkout…' : `Keep Playing (${VERSUS_LIFE_PURCHASE_PRICE_SATS} sats)`}
          </button>
