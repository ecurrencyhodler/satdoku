  ...
  return {
    ...
    players: {
      player1: {
        ...
        connected: roomState.players.player1?.connected, // Don't default - let UI handle undefined vs false
      ...
      player2: roomState.players.player2 ? {
        ...
        connected: roomState.players.player2.connected, // Don't default - let UI handle undefined vs false
